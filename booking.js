(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["EasyViewing"] = factory(require("jquery"));
	else
		root["EasyViewing"] = factory(root["jQuery"]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var interpolate     = __webpack_require__(6);
	window.fullcalendar = __webpack_require__(8);
	...
	var defaultConfig = __webpack_require__(20);
	...
	function EasyViewing() {
	  ...
	  var prepareDOM = function(suppliedConfig) {
	    ...
	    //Add the modal style
	    rootTarget.addClass('modal');
	    //rootTarget.addClass('cleanslate');
	  ...
	  var getAvailability = function() {
	    ...
	    //Need to call renderCalendarEvents(response.data);
	    //Need to call hide Loading Screen
	    var eventArray = [
	      {
	        title: 'Viewing 1',
	        start: moment('2017-11-11T08:00:00'),
	        end: moment('2017-11-11T09:00:00')
	      },
	      {
	        title: 'Viewing 2',
	        start: moment('2017-11-11T10:00:00'),
	        end: moment('2017-11-11T11:00:00')
	      },
	      {
	        title: 'Viewing 1',
	        start: moment('2017-11-12T08:00:00'),
	        end: moment('2017-11-12T09:00:00')
	      },
	      {
	        title: 'Viewing 1',
	        start: moment('2017-11-12T11:00:00'),
	        end: moment('2017-11-12T11:00:00')
	      },
	    ]
	    renderCalendarEvents(eventArray);
	    hideLoadingScreen();
	  ...
	  var decideCalendarSize = function(currentView) {
	    ...
	    if (!config.localization.showcloserhelper) { height += 33; }
	  ...
	  var showLoadingScreen = function() {
	    ...
	    loadingTarget = $(template.render({
	      loadingIcon: __webpack_require__(36)
	    }));
	  ...
	  var triggerError = function(message) {
	    ...
	    errorTarget = $(template.render({
	      errorWarningIcon: __webpack_require__(38),
	  ...
	  var showBookingPage = function(eventData) {
	    ...
	    var fieldsTemplate = __webpack_require__(39);
	    ...
	    bookingPageTarget = $(template.render({
	      ...
	      closeIcon:                __webpack_require__(41),
	      checkmarkIcon:            __webpack_require__(42),
	      loadingIcon:              __webpack_require__(36),
	      errorIcon:                __webpack_require__(43),
	    ...
	    // Show powered by EasyViewing message
	  ...
	  var submitBookingForm = function(form, e, eventData) {
	    ...
	    /*
	    * This is the Promise you would call when you book an event
	    */
	    var promise = new Promise(function(resolve,reject){
	      console.log('The booking infos:', eventData);
	      resolve(true)
	    })
	  ...
	  // Render the powered by EasyViewing message
	  var renderPoweredByMessage = function(pageTarget) {
	    ...
	    var timekitLogo = __webpack_require__(45);
	  ...
	  var renderCloserHelper = function() {
	    var template = __webpack_require__(46);
	    
	    var closerHelperTarget = $(template.render({
	      loadingText: 'Bitch',
	      loading: true
	    }));
	    closerHelperTarget.children('.bookingjs-form-button').click(function(e) {
	      hide();
	    });
	    rootTarget.addClass('has-closerhelper');
	    rootTarget.append(closerHelperTarget)
	  }
	  // Render method
	  var render = function() {
	  ...
	  var hide = function() {
	    var widgetInParent = config.parent.document.getElementById("easybooking-widget")
	    widgetInParent.style.opacity = 0;
	    setTimeout(function(){ widgetInParent.style.zIndex = -1;; }, 500); 
	  }
	...
	if (window && globalLibraryConfig && globalLibraryConfig.autoload !== false) {
	  $(window).on('load', function(){
	    var instance = new EasyViewing();
	    instance.init(globalLibraryConfig);
	    module.exports = instance;
	  });
	} else {
	  module.exports = EasyViewing;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function(factory) {
		if (true) {
			!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(5), __webpack_require__(9) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(17)(content, {"singleton":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"bookingjs-ribbon-wrapper\">\r");t.b("\n" + i);t.b("  <div class=\"bookingjs-ribbon-container\">\r");t.b("\n" + i);t.b("    <div class=\"bookingjs-ribbon\">\r");t.b("\n" + i);t.b("      <span>\r");t.b("\n" + i);t.b("        ");t.b(t.v(t.f("ribbonText",c,p,0)));t.b("\r");t.b("\n" + i);t.b("      </span>\r");t.b("\n" + i);t.b("    </div>\r");t.b("\n" + i);t.b("  </div>\r");t.b("\n" + i);t.b("</div>\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"bookingjs-ribbon-wrapper\">\r\n  <div class=\"bookingjs-ribbon-container\">\r\n    <div class=\"bookingjs-ribbon\">\r\n      <span>\r\n        {{ ribbonText }}\r\n      </span>\r\n    </div>\r\n  </div>\r\n</div>\r\n", H);return T; }();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var H = __webpack_require__(30);
	module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"bookingjs-avatar\">\r");t.b("\n" + i);t.b("  <img src=\"");t.b(t.t(t.f("image",c,p,0)));t.b("\" />\r");t.b("\n" + i);t.b("</div>\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"bookingjs-avatar\">\r\n  <img src=\"{{& image }}\" />\r\n</div>\r\n", H);return T; }();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var H = __webpack_require__(30);
	module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"bookingjs-displayname\">\r");t.b("\n" + i);t.b("  <span>");t.b(t.v(t.f("name",c,p,0)));t.b("</span>\r");t.b("\n" + i);t.b("</div>\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"bookingjs-displayname\">\r\n  <span>{{ name }}</span>\r\n</div>\r\n", H);return T; }();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var H = __webpack_require__(30);
	module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"bookingjs-loading show\">\r");t.b("\n" + i);t.b("  <div class=\"bookingjs-loading-icon\">\r");t.b("\n" + i);t.b("    ");t.b(t.t(t.f("loadingIcon",c,p,0)));t.b("\r");t.b("\n" + i);t.b("  </div>\r");t.b("\n" + i);t.b("</div>\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"bookingjs-loading show\">\r\n  <div class=\"bookingjs-loading-icon\">\r\n    {{& loadingIcon }}\r\n  </div>\r\n</div>\r\n", H);return T; }();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var H = __webpack_require__(30);
	module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"bookingjs-error show\">\r");t.b("\n" + i);t.b("  <div class=\"bookingjs-error-inner\">\r");t.b("\n" + i);t.b("    <div class=\"bookingjs-error-icon\">\r");t.b("\n" + i);t.b("      ");t.b(t.t(t.f("errorWarningIcon",c,p,0)));t.b("\r");t.b("\n" + i);t.b("    </div>\r");t.b("\n" + i);t.b("    <div class=\"bookingjs-error-heading\">\r");t.b("\n" + i);t.b("      Ouch, we've encountered a problem\r");t.b("\n" + i);t.b("    </div>\r");t.b("\n" + i);t.b("    <div class=\"bookingjs-error-text\">\r");t.b("\n" + i);t.b("      <span class=\"bookingjs-error-text-message\">");t.b(t.t(t.f("message",c,p,0)));t.b("</span>\r");t.b("\n" + i);t.b("      <span class=\"bookingjs-error-text-context\">");t.b(t.t(t.f("context",c,p,0)));t.b("</span>\r");t.b("\n" + i);t.b("    </div>\r");t.b("\n" + i);t.b("  </div>\r");t.b("\n" + i);t.b("</div>\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"bookingjs-error show\">\r\n  <div class=\"bookingjs-error-inner\">\r\n    <div class=\"bookingjs-error-icon\">\r\n      {{& errorWarningIcon }}\r\n    </div>\r\n    <div class=\"bookingjs-error-heading\">\r\n      Ouch, we've encountered a problem\r\n    </div>\r\n    <div class=\"bookingjs-error-text\">\r\n      <span class=\"bookingjs-error-text-message\">{{& message }}</span>\r\n      <span class=\"bookingjs-error-text-context\">{{& context }}</span>\r\n    </div>\r\n  </div>\r\n</div>\r\n", H);return T; }();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var H = __webpack_require__(30);
	module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"bookingjs-form-field\">\r");t.b("\n" + i);t.b("  <label\r");t.b("\n" + i);t.b("    for=\"input-name\"\r");t.b("\n" + i);t.b("    class=\"bookingjs-form-label label-name\">\r");t.b("\n" + i);t.b("    ");t.b(t.v(t.d("fields.name.placeholder",c,p,0)));t.b("\r");t.b("\n" + i);t.b("  </label>\r");t.b("\n" + i);t.b("  <input\r");t.b("\n" + i);t.b("    id=\"input-name\"\r");t.b("\n" + i);t.b("    class=\"bookingjs-form-input input-name\"\r");t.b("\n" + i);t.b("    type=\"text\"\r");t.b("\n" + i);t.b("    name=\"name\"\r");t.b("\n" + i);t.b("    placeholder=\"");t.b(t.v(t.d("fields.name.placeholder",c,p,0)));t.b("\"\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.name.prefilled",c,p,1),c,p,0,352,389,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" value=\"");t.b(t.v(t.d("fields.name.prefilled",c,p,0)));t.b("\" ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.name.locked",c,p,1),c,p,0,448,458,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" readonly ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("    required\r");t.b("\n" + i);t.b("  />\r");t.b("\n" + i);t.b("</div>\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("<div class=\"bookingjs-form-field\">\r");t.b("\n" + i);t.b("  <label\r");t.b("\n" + i);t.b("    for=\"input-email\"\r");t.b("\n" + i);t.b("    class=\"bookingjs-form-label label-email\">\r");t.b("\n" + i);t.b("    ");t.b(t.v(t.d("fields.email.placeholder",c,p,0)));t.b("\r");t.b("\n" + i);t.b("  </label>\r");t.b("\n" + i);t.b("  <input\r");t.b("\n" + i);t.b("    id=\"input-email\"\r");t.b("\n" + i);t.b("    class=\"bookingjs-form-input input-email\"\r");t.b("\n" + i);t.b("    type=\"email\"\r");t.b("\n" + i);t.b("    name=\"email\"\r");t.b("\n" + i);t.b("    placeholder=\"");t.b(t.v(t.d("fields.email.placeholder",c,p,0)));t.b("\"\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.email.prefilled",c,p,1),c,p,0,876,914,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" value=\"");t.b(t.v(t.d("fields.email.prefilled",c,p,0)));t.b("\" ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.email.locked",c,p,1),c,p,0,975,985,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" readonly ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("    required\r");t.b("\n" + i);t.b("  />\r");t.b("\n" + i);t.b("</div>\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);if(t.s(t.d("fields.phone.enabled",c,p,1),c,p,0,1070,1654,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<div class=\"bookingjs-form-field\">\r");t.b("\n" + i);t.b("  <label\r");t.b("\n" + i);t.b("    for=\"input-phone\"\r");t.b("\n" + i);t.b("    class=\"bookingjs-form-label label-phone\">\r");t.b("\n" + i);t.b("    ");t.b(t.v(t.d("fields.phone.placeholder",c,p,0)));t.b("\r");t.b("\n" + i);t.b("  </label>\r");t.b("\n" + i);t.b("  <input\r");t.b("\n" + i);t.b("    id=\"input-phone\"\r");t.b("\n" + i);t.b("    class=\"bookingjs-form-input input-phone\"\r");t.b("\n" + i);t.b("    type=\"tel\"\r");t.b("\n" + i);t.b("    name=\"phone\"\r");t.b("\n" + i);t.b("    placeholder=\"");t.b(t.v(t.d("fields.phone.placeholder",c,p,0)));t.b("\"\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.phone.prefilled",c,p,1),c,p,0,1431,1469,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" value=\"");t.b(t.v(t.d("fields.phone.prefilled",c,p,0)));t.b("\" ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.phone.required",c,p,1),c,p,0,1532,1542,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" required ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.phone.locked",c,p,1),c,p,0,1602,1612,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" readonly ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("  />\r");t.b("\n" + i);t.b("</div>\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);if(t.s(t.d("fields.voip.enabled",c,p,1),c,p,0,1711,2282,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<div class=\"bookingjs-form-field\">\r");t.b("\n" + i);t.b("  <label\r");t.b("\n" + i);t.b("    for=\"input-voip\"\r");t.b("\n" + i);t.b("    class=\"bookingjs-form-label label-voip\">\r");t.b("\n" + i);t.b("    ");t.b(t.v(t.d("fields.voip.placeholder",c,p,0)));t.b("\r");t.b("\n" + i);t.b("  </label>\r");t.b("\n" + i);t.b("  <input\r");t.b("\n" + i);t.b("    id=\"input-voip\"\r");t.b("\n" + i);t.b("    class=\"bookingjs-form-input input-voip\"\r");t.b("\n" + i);t.b("    type=\"text\"\r");t.b("\n" + i);t.b("    name=\"voip\"\r");t.b("\n" + i);t.b("    placeholder=\"");t.b(t.v(t.d("fields.voip.placeholder",c,p,0)));t.b("\"\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.voip.prefilled",c,p,1),c,p,0,2065,2102,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" value=\"");t.b(t.v(t.d("fields.voip.prefilled",c,p,0)));t.b("\" ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.voip.required",c,p,1),c,p,0,2163,2173,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" required ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.voip.locked",c,p,1),c,p,0,2231,2241,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" readonly ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("  />\r");t.b("\n" + i);t.b("</div>\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);if(t.s(t.d("fields.location.enabled",c,p,1),c,p,0,2342,2969,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<div class=\"bookingjs-form-field\">\r");t.b("\n" + i);t.b("  <label\r");t.b("\n" + i);t.b("    for=\"input-location\"\r");t.b("\n" + i);t.b("    class=\"bookingjs-form-label label-location\">\r");t.b("\n" + i);t.b("    ");t.b(t.v(t.d("fields.location.placeholder",c,p,0)));t.b("\r");t.b("\n" + i);t.b("  </label>\r");t.b("\n" + i);t.b("  <input\r");t.b("\n" + i);t.b("    id=\"input-location\"\r");t.b("\n" + i);t.b("    class=\"bookingjs-form-input input-location\"\r");t.b("\n" + i);t.b("    type=\"text\"\r");t.b("\n" + i);t.b("    name=\"location\"\r");t.b("\n" + i);t.b("    placeholder=\"");t.b(t.v(t.d("fields.location.placeholder",c,p,0)));t.b("\"\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.location.prefilled",c,p,1),c,p,0,2728,2769,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" value=\"");t.b(t.v(t.d("fields.location.prefilled",c,p,0)));t.b("\" ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.location.required",c,p,1),c,p,0,2838,2848,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" required ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.location.locked",c,p,1),c,p,0,2914,2924,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" readonly ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("  />\r");t.b("\n" + i);t.b("</div>\r");t.b("\n" + i);});c.pop();}t.b("\r");t.b("\n" + i);if(t.s(t.d("fields.comment.enabled",c,p,1),c,p,0,3032,3666,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<div class=\"bookingjs-form-field\">\r");t.b("\n" + i);t.b("  <label\r");t.b("\n" + i);t.b("    for=\"input-comment\"\r");t.b("\n" + i);t.b("    class=\"bookingjs-form-label label-comment\">\r");t.b("\n" + i);t.b("    ");t.b(t.v(t.d("fields.comment.placeholder",c,p,0)));t.b("\r");t.b("\n" + i);t.b("  </label>\r");t.b("\n" + i);t.b("  <textarea\r");t.b("\n" + i);t.b("    id=\"input-comment\"\r");t.b("\n" + i);t.b("    class=\"bookingjs-form-input bookingjs-form-input--textarea input-comment\"\r");t.b("\n" + i);t.b("    rows=\"3\"\r");t.b("\n" + i);t.b("    name=\"comment\"\r");t.b("\n" + i);t.b("    placeholder=\"");t.b(t.v(t.d("fields.comment.placeholder",c,p,0)));t.b("\"\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.comment.required",c,p,1),c,p,0,3440,3450,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" required ");});c.pop();}t.b("\r");t.b("\n" + i);t.b("    ");if(t.s(t.d("fields.comment.locked",c,p,1),c,p,0,3514,3524,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(" readonly ");});c.pop();}t.b(">");if(t.s(t.d("fields.comment.prefilled",c,p,1),c,p,0,3584,3614,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(t.v(t.d("fields.comment.prefilled",c,p,0)));});c.pop();}t.b("</textarea>\r");t.b("\n" + i);t.b("</div>\r");t.b("\n" + i);});c.pop();}return t.fl(); },partials: {}, subs: {  }}, "<div class=\"bookingjs-form-field\">\r\n  <label\r\n    for=\"input-name\"\r\n    class=\"bookingjs-form-label label-name\">\r\n    {{ fields.name.placeholder }}\r\n  </label>\r\n  <input\r\n    id=\"input-name\"\r\n    class=\"bookingjs-form-input input-name\"\r\n    type=\"text\"\r\n    name=\"name\"\r\n    placeholder=\"{{ fields.name.placeholder }}\"\r\n    {{# fields.name.prefilled }} value=\"{{ fields.name.prefilled }}\" {{/ fields.name.prefilled }}\r\n    {{# fields.name.locked }} readonly {{/ fields.name.locked }}\r\n    required\r\n  />\r\n</div>\r\n\r\n<div class=\"bookingjs-form-field\">\r\n  <label\r\n    for=\"input-email\"\r\n    class=\"bookingjs-form-label label-email\">\r\n    {{ fields.email.placeholder }}\r\n  </label>\r\n  <input\r\n    id=\"input-email\"\r\n    class=\"bookingjs-form-input input-email\"\r\n    type=\"email\"\r\n    name=\"email\"\r\n    placeholder=\"{{ fields.email.placeholder }}\"\r\n    {{# fields.email.prefilled }} value=\"{{ fields.email.prefilled }}\" {{/ fields.email.prefilled }}\r\n    {{# fields.email.locked }} readonly {{/ fields.email.locked }}\r\n    required\r\n  />\r\n</div>\r\n\r\n{{# fields.phone.enabled }}\r\n<div class=\"bookingjs-form-field\">\r\n  <label\r\n    for=\"input-phone\"\r\n    class=\"bookingjs-form-label label-phone\">\r\n    {{ fields.phone.placeholder }}\r\n  </label>\r\n  <input\r\n    id=\"input-phone\"\r\n    class=\"bookingjs-form-input input-phone\"\r\n    type=\"tel\"\r\n    name=\"phone\"\r\n    placeholder=\"{{ fields.phone.placeholder }}\"\r\n    {{# fields.phone.prefilled }} value=\"{{ fields.phone.prefilled }}\" {{/ fields.phone.prefilled }}\r\n    {{# fields.phone.required }} required {{/ fields.phone.required }}\r\n    {{# fields.phone.locked }} readonly {{/ fields.phone.locked }}\r\n  />\r\n</div>\r\n{{/ fields.phone.enabled }}\r\n\r\n{{# fields.voip.enabled }}\r\n<div class=\"bookingjs-form-field\">\r\n  <label\r\n    for=\"input-voip\"\r\n    class=\"bookingjs-form-label label-voip\">\r\n    {{ fields.voip.placeholder }}\r\n  </label>\r\n  <input\r\n    id=\"input-voip\"\r\n    class=\"bookingjs-form-input input-voip\"\r\n    type=\"text\"\r\n    name=\"voip\"\r\n    placeholder=\"{{ fields.voip.placeholder }}\"\r\n    {{# fields.voip.prefilled }} value=\"{{ fields.voip.prefilled }}\" {{/ fields.voip.prefilled }}\r\n    {{# fields.voip.required }} required {{/ fields.voip.required }}\r\n    {{# fields.voip.locked }} readonly {{/ fields.voip.locked }}\r\n  />\r\n</div>\r\n{{/ fields.voip.enabled }}\r\n\r\n{{# fields.location.enabled }}\r\n<div class=\"bookingjs-form-field\">\r\n  <label\r\n    for=\"input-location\"\r\n    class=\"bookingjs-form-label label-location\">\r\n    {{ fields.location.placeholder }}\r\n  </label>\r\n  <input\r\n    id=\"input-location\"\r\n    class=\"bookingjs-form-input input-location\"\r\n    type=\"text\"\r\n    name=\"location\"\r\n    placeholder=\"{{ fields.location.placeholder }}\"\r\n    {{# fields.location.prefilled }} value=\"{{ fields.location.prefilled }}\" {{/ fields.location.prefilled }}\r\n    {{# fields.location.required }} required {{/ fields.location.required }}\r\n    {{# fields.location.locked }} readonly {{/ fields.location.locked }}\r\n  />\r\n</div>\r\n{{/ fields.location.enabled }}\r\n\r\n{{# fields.comment.enabled }}\r\n<div class=\"bookingjs-form-field\">\r\n  <label\r\n    for=\"input-comment\"\r\n    class=\"bookingjs-form-label label-comment\">\r\n    {{ fields.comment.placeholder }}\r\n  </label>\r\n  <textarea\r\n    id=\"input-comment\"\r\n    class=\"bookingjs-form-input bookingjs-form-input--textarea input-comment\"\r\n    rows=\"3\"\r\n    name=\"comment\"\r\n    placeholder=\"{{ fields.comment.placeholder }}\"\r\n    {{# fields.comment.required }} required {{/ fields.comment.required }}\r\n    {{# fields.comment.locked }} readonly {{/ fields.comment.locked }}>{{# fields.comment.prefilled }}{{ fields.comment.prefilled }}{{/ fields.comment.prefilled }}</textarea>\r\n</div>\r\n{{/ fields.comment.enabled }}\r\n", H);return T; }();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var H = __webpack_require__(30);
	module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"bookingjs-bookpage\">\r");t.b("\n" + i);t.b("  <a class=\"bookingjs-bookpage-close\" href=\"#\">");t.b(t.t(t.f("closeIcon",c,p,0)));t.b("</a>\r");t.b("\n" + i);t.b("  <div class=\"bookingjs-bookpage-header\">\r");t.b("\n" + i);t.b("    <h2 class=\"bookingjs-bookpage-date\">");t.b(t.v(t.f("chosenDate",c,p,0)));t.b("</h2>\r");t.b("\n" + i);t.b("    <h3 class=\"bookingjs-bookpage-time\">");t.b(t.v(t.f("chosenTime",c,p,0)));t.b("</h3>\r");t.b("\n" + i);if(t.s(t.f("allocatedResource",c,p,1),c,p,0,298,473,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("      <span class=\"bookingjs-bookpage-resource-prefix\">");t.b(t.v(t.f("allocatedResourcePrefix",c,p,0)));t.b("</span>\r");t.b("\n" + i);t.b("      <h3 class=\"bookingjs-bookpage-resource\">");t.b(t.v(t.f("allocatedResource",c,p,0)));t.b("</h3>\r");t.b("\n" + i);});c.pop();}t.b("  </div>\r");t.b("\n" + i);t.b("  <form class=\"bookingjs-form\" action=\"#\">\r");t.b("\n" + i);t.b("    <div class=\"bookingjs-form-box\">\r");t.b("\n" + i);t.b("      <div class=\"bookingjs-form-success-message\">\r");t.b("\n" + i);t.b("        <div class=\"title\">");t.b(t.v(t.f("successMessageTitle",c,p,0)));t.b("</div>\r");t.b("\n" + i);t.b("        <div class=\"body\">");t.b(t.t(t.f("successMessageBody",c,p,0)));t.b("</div>\r");t.b("\n" + i);t.b("      </div>\r");t.b("\n" + i);t.b("      <div class=\"bookingjs-form-fields\">\r");t.b("\n" + i);t.b(t.rp("<formFields0",c,p,"        "));t.b("      </div>\r");t.b("\n" + i);t.b("    </div>\r");t.b("\n" + i);t.b("    <button class=\"bookingjs-form-button\" type=\"submit\">\r");t.b("\n" + i);t.b("      <span class=\"inactive-text\">");t.b(t.v(t.f("submitText",c,p,0)));t.b("</span>\r");t.b("\n" + i);t.b("      <span class=\"loading-text\">");t.b(t.t(t.f("loadingIcon",c,p,0)));t.b("</span>\r");t.b("\n" + i);t.b("      <span class=\"error-text\">");t.b(t.t(t.f("errorIcon",c,p,0)));t.b("</span>\r");t.b("\n" + i);t.b("      <span class=\"success-text\">");t.b(t.t(t.f("checkmarkIcon",c,p,0)));t.b("</span>\r");t.b("\n" + i);t.b("    </button>\r");t.b("\n" + i);t.b("  </form>\r");t.b("\n" + i);t.b("</div>\r");t.b("\n");return t.fl(); },partials: {"<formFields0":{name:"formFields", partials: {}, subs: {  }}}, subs: {  }}, "<div class=\"bookingjs-bookpage\">\r\n  <a class=\"bookingjs-bookpage-close\" href=\"#\">{{& closeIcon }}</a>\r\n  <div class=\"bookingjs-bookpage-header\">\r\n    <h2 class=\"bookingjs-bookpage-date\">{{ chosenDate }}</h2>\r\n    <h3 class=\"bookingjs-bookpage-time\">{{ chosenTime }}</h3>\r\n    {{#allocatedResource}}\r\n      <span class=\"bookingjs-bookpage-resource-prefix\">{{ allocatedResourcePrefix }}</span>\r\n      <h3 class=\"bookingjs-bookpage-resource\">{{ allocatedResource }}</h3>\r\n    {{/allocatedResource}}\r\n  </div>\r\n  <form class=\"bookingjs-form\" action=\"#\">\r\n    <div class=\"bookingjs-form-box\">\r\n      <div class=\"bookingjs-form-success-message\">\r\n        <div class=\"title\">{{ successMessageTitle }}</div>\r\n        <div class=\"body\">{{& successMessageBody }}</div>\r\n      </div>\r\n      <div class=\"bookingjs-form-fields\">\r\n        {{> formFields }}\r\n      </div>\r\n    </div>\r\n    <button class=\"bookingjs-form-button\" type=\"submit\">\r\n      <span class=\"inactive-text\">{{ submitText }}</span>\r\n      <span class=\"loading-text\">{{& loadingIcon }}</span>\r\n      <span class=\"error-text\">{{& errorIcon }}</span>\r\n      <span class=\"success-text\">{{& checkmarkIcon }}</span>\r\n    </button>\r\n  </form>\r\n</div>\r\n", H);return T; }();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var H = __webpack_require__(30);
	module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"bookingjs-poweredby\">\r");t.b("\n" + i);t.b("  <a href=\"http://easyviewing.io?utm_medium=link&utm_source=");t.b(t.v(t.f("campaignSource",c,p,0)));t.b("&utm_campaign=");t.b(t.v(t.f("campaignName",c,p,0)));t.b("&utm_content=powered-by\" target=\"_blank\">\r");t.b("\n" + i);t.b("    ");t.b(t.t(t.f("timekitLogo",c,p,0)));t.b("\r");t.b("\n" + i);t.b("    <span>Powered by J&J Easy Viewing</span>\r");t.b("\n" + i);t.b("  </a>\r");t.b("\n" + i);t.b("</div>\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"bookingjs-poweredby\">\r\n  <a href=\"http://easyviewing.io?utm_medium=link&utm_source={{ campaignSource }}&utm_campaign={{ campaignName }}&utm_content=powered-by\" target=\"_blank\">\r\n    {{& timekitLogo }}\r\n    <span>Powered by J&J Easy Viewing</span>\r\n  </a>\r\n</div>\r\n", H);return T; }();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var H = __webpack_require__(30);
	module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"bookingjs-closerhelper\">\r");t.b("\n" + i);t.b("    <button class=\"bookingjs-form-button nomargin\" type=\"submit\">\r");t.b("\n" + i);t.b("        <span class=\"inactive-text\">Close</span>\r");t.b("\n" + i);t.b("    </button>\r");t.b("\n" + i);t.b("</div>\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"bookingjs-closerhelper\">\r\n    <button class=\"bookingjs-form-button nomargin\" type=\"submit\">\r\n        <span class=\"inactive-text\">Close</span>\r\n    </button>\r\n</div>\r\n", H);return T; }();
